...
# Function that takes desired distance, and desired position (x,y) as arguments and returns whether MELVIN can reach that from hiw current position in time
def time_computation(desired_dist):
