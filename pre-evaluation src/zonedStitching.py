...
@params:
    ...
    bottom_right: Tuple (x, y) of the bottom-right corner
    
Returns:
    canvas: The initialized canvas
    stitched_images: Dictionary to track stitched images
    origin: Tuple (x, y) of the canvas origin in the global coordinate system
'''
...
@params:
    ...
    filenames: List of filenames to stitch
    canvas: The canvas numpy array
    stitched_images: Dictionary to track stitched images
    origin: Tuple (x, y) of the canvas origin in the global coordinate system
'''
...
''' 
@params
    canvas: the canvas with the desired dimensions
'''
...
''' 
@params
    top_left: (x_min, y_min) coordinates of the top left corner
    bottom_right: (x_max, y_max) coordinates of the bottom right corner
    specific_files: the list of the desired image names to look for
'''
...
if __name__ == '__main__':
    ...
    specific_files = [
        "lens1_14300_3806.jpg",
        "lens1_14405_2393.jpg",
        "lens1_14030_4960.jpg",
        # Add more filenames as needed
    ]

    # Define the area we want to capture (based on the coordinates of the images)
    # You can calculate this dynamically from the list of filenames if needed
    top_left = (14000, 1000)  # Example values (xmin, ymin)
    bottom_right = (14500, 5700)  # Example values (xmax, ymax)

    stitch_zoned(top_left, bottom_right, specific_files)